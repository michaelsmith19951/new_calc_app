...
# Functions for each test
	...
	def test_if_string_entered_equals_nil2_subtraction
		assert_equal(nil, subtraction(67, ""))
	end
	...
	def test_if_string_entered_equals_nil1_multiplication
		assert_equal(nil, multiplication("", 48))
	end
	...
	def test_if_array_entered_equals_nil1_multiplication
		assert_equal(nil, multiplication([], 48))
	end
	...
	def test_if_string_entered_equals_nil2_division
		assert_equal(nil, division(78, ""))
	end
	...
	def test_if_array_entered_equals_nil2_division
		assert_equal(nil, division(36, []))
	end
end
